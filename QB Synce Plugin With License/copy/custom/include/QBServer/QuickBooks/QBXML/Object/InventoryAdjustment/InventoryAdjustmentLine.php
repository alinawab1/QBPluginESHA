...
class QuickBooks_QBXML_Object_InventoryAdjustment_InventoryAdjustmentLine extends QuickBooks_QBXML_Object
{
	...
	{
		return $this->getD('QuantityAdjustment NewQuantity');
	}
	...
	{
		return $this->getD('QuantityAdjustment QuantityDifference');
	}
	...
	{
		return $this->getD('ValueAdjustment NewQuantity');
	}
	...
	{
		return $this->getD('ValueAdjustment NewValue');
	}
