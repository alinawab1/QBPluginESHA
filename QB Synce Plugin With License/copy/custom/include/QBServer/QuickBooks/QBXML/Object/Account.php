...
class QuickBooks_QBXML_Object_Account extends QuickBooks_QBXML_Object
{
	...
	{
		return $this->getD('SpecialAccountType');
	}
	...
	{
		return $this->getD('CashFlowClassification');
	}
