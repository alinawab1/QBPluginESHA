...
class QuickBooks_QBXML_Object_InventoryAdjustment extends QuickBooks_QBXML_Object
{
	...
	{
		return $this->getD('AccountRef ListID');
	}
	...
	{
		return $this->getD('AccountRef FullName');
	}
...
/*
	...
	{
		return $this->getD('RefNumberCaseSensitive');
	}
	...
	{
		return $this->getD('EntityFilter ListID');
	}
	...
	{
		return $this->getD('EntityFilter FullName');
	}
	...
	{
		return $this->getD('EntityFilter ListIDWithChildren');
	}
	...
	{
		return $this->getD('EntityFilter FullNameWithChildren');
	}
	...
	{
		return $this->getD('AccountFilter ListIDWithChildren');
	}
	...
	{
		return $this->getD('AccountFilter FullNameWithChildren');
	}
	...
	{
		return $this->getD('ItemFilter ListID');
	}
	...
	{
		return $this->getD('ItemFilter FullName');
	}
	...
	{
		return $this->getD('ItemFilter ListIDWithChildren');
	}
	...
	{
		return $this->getD('ItemFilter FullNameWithChildren');
	}
	...
	{
		return $this->getD('RefNumberFilter MatchCriterion');
	}
	...
	{
		return $this->getD('RefNumberFilter RefNumber');
	}
	...
	{
		return $this->getD('RefNumberRangeFilter FromRefNumber');
	}
	...
	{
		return $this->getD('RefNumberRangeFilter ToRefNumber');
	}
...
/*
	...
	{
		return $this->getD('IncludeLineItems');
	}
	...
	{
		return $this->getD('IncludeRetElement');
	}
