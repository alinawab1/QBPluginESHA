...
class QuickBooks_QBXML_Object_Invoice_InvoiceLine extends QuickBooks_QBXML_Object
{
	...
	{
		return $this->getD('ItemRef ListID');
	}
	...
	{
		//print($this->getD('ItemRef ' . QUICKBOOKS_API_APPLICATIONID) . '<br />');
		
		return $this->extractApplicationID($this->getD('ItemRef ' . QUICKBOOKS_API_APPLICATIONID));
	}
	...
	{
		return $this->getD('ItemRef FullName');
	}
	...
	{
		return $this->getD('UnitOfMeasure');
	}
	...
	{
		return $this->getD('Rate');
	}
	
	public function getAmount()
	{
		if ($amount = $this->getD('Amount'))
		{
			return $this->getD('Amount');
		}
		
		return $this->getD('Rate') * $this->getD('Quantity');
	}
	...
	{
		return $this->getD('SalesTaxCodeRef FullName') == QUICKBOOKS_TAXABLE;
	}
	...
	{
		return $this->getD('OverrideItemAccountRef ListID');
	}
	
	public function getOverrideItemAccountName()
	{
		return $this->getD('OverrideItemAccountRef FullName');
	}
