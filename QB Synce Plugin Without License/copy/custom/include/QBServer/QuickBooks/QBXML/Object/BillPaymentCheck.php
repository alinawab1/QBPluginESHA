...
class QuickBooks_QBXML_Object_BillPaymentCheck extends QuickBooks_QBXML_Object
{
	...
	{
		return $this->getD('PayeeEntityRef ' . QUICKBOOKS_API_APPLICATIONID);
	}
	...
	{
		return $this->getD('PayeeEntityRef ListID');
	}
	...
	{
		return $this->getD('PayeeEntityRef FullName');
	}
	...
	{
		return $this->getD('APAccountRef ' . QUICKBOOKS_API_APPLICATIONID);
	}
	
	public function getAPAccountListID()
	{
		return $this->getD('APAccountRef ListID');
	}
	
	public function getAPAccountFullName()
	{
		return $this->getD('APAccountRef FullName');
	}
	...
	{
		return $this->getD('BankAccountRef ' . QUICKBOOKS_API_APPLICATIONID);
	}
	
	public function getBankAccountListID()
	{
		return $this->getD('BankAccountRef ListID');
	}
	
	public function getBankAccountFullName()
	{
		return $this->getD('BankAccountRef FullName');
	}
