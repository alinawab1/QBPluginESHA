 ...
 * PLACE ANY CUSTOMIZATIONS IN SalesHistory
 */

require_once 'include/SugarObjects/templates/company/Company.php';

class SalesHistory_sugar extends Company {
    public $new_schema = true;
    public $module_dir = 'SalesHistory';
    public $object_name = 'SalesHistory';
    public $table_name = 'saleshistory';
     ...
     * @deprecated
     */
    public function SalesHistory_sugar(){
        $GLOBALS['log']->deprecated('Calls to SalesHistory::SalesHistory are deprecated.');
        self::__construct();
    }
