...
class QuickBooks_QBXML_Object_ServiceItem extends QuickBooks_QBXML_Object
{
	...
	{
		return $this->getD('ParentRef ListID');	
	}
	
	public function getParentName()
	{
		return $this->getD('ParentRef FullName');
	}
	
	public function getParentApplicationID()
	{
		return $this->extractApplicationID($this->getD('ParentRef ' . QUICKBOOKS_API_APPLICATIONID));
	}
	...
	{
		return $this->getD('SalesTaxCodeRef ListID');
	}
	
	public function getSalesTaxCodeName()
	{
		return $this->getD('SalesTaxCodeRef FullName');
	}
	
	public function getSalesTaxCodeApplicationID()
	{
		return $this->extractApplicationID($this->getD('SalesTaxCodeRef ' . QUICKBOOKS_API_APPLICATIONID));
	}

	public function getUnitOfMeasureSetListID()
	{
		return $this->getD('UnitOfMeasureSetRef ListID');
	}
	
	public function getUnitOfMeasureSetFullName()
	{
		return $this->getD('UnitOfMeasureSetRef FullName');
	}
  ...
  {
    return $this->getD('SalesOrPurchase Desc');
  }
	...
	{
		return $this->getD('SalesOrPurchase Price');
	}
	...
	{
		return $this->getD('SalesOrPurchase PricePercent');
	}
	...
	{
		return $this->getD('SalesOrPurchase AccountRef ' . QUICKBOOKS_API_APPLICATIONID);
	}
	...
	{
		return $this->getD('SalesOrPurchase AccountRef ListID');
	}
	...
	{
		return $this->getD('SalesOrPurchase AccountRef FullName');
	}
	...
	{
		return $this->getD('SalesAndPurchase SalesDesc');
	}
	...
	{
		return $this->getD('SalesAndPurchase SalesPrice');
	}
	...
	{
		return $this->getD('SalesAndPurchase IncomeAccountRef ListID');
	}
	...
	{
		return $this->getD('SalesAndPurchase IncomeAccountRef FullName');
	}
	...
	{
		return $this->getD('SalesAndPurchase IncomeAccountRef ' . QUICKBOOKS_API_APPLICATIONID);
	}
	...
	{
		return $this->getD('SalesAndPurchase PurchaseDesc');
	}
	...
	{
		return $this->getD('SalesAndPurchase PurchaseCost');
	}
	...
	{
		return $this->getD('SalesAndPurchase ExpenseAccountRef ' . QUICKBOOKS_API_APPLICATIONID);
	}
	
	public function getExpenseAccountListID()
	{
		return $this->getD('SalesAndPurchase ExpenseAccountRef ListID');
	}
	
	public function getExpenseAccountName()
	{
		return $this->getD('SalesAndPurchase ExpenseAccountRef FullName');
	}
	...
	{
		return $this->getD('SalesAndPurchase PrefVendorRef ' . QUICKBOOKS_API_APPLICATIONID);
	}
	
	public function getPreferredVendorListID()
	{
		return $this->getD('SalesAndPurchase PrefVendorRef ListID');
	}
	
	public function getPreferredVendorName()
	{
		return $this->getD('SalesAndPurchase PrefVendorRef FullName');
	}
