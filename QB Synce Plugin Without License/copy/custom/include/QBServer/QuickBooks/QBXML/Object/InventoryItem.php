...
class QuickBooks_QBXML_Object_InventoryItem extends QuickBooks_QBXML_Object
{
	...
	{
		return $this->getD('QuantityOnHand');
	}
	...
	{
		return $this->getD('IncomeAccountRef ' . QUICKBOOKS_API_APPLICATIONID);
	}
	...
	{
		return $this->getD('IncomeAccountRef ListID');
	}
	...
	{
		return $this->getD('IncomeAccountRef FullName');
	}
	...
	{
		return $this->getD('AssetAccountRef FullName');
	}
	...
	{
		return $this->getD('AssetAccountRef ListID');
	}
	...
	{
		return $this->getD('AssetAccountRef ' . QUICKBOOKS_API_APPLICATIONID);
	}
	...
	{
		return $this->getD('COGSAccountRef ' . QUICKBOOKS_API_APPLICATIONID);
	}
	
	public function getCOGSAccountListID()
	{
		return $this->getD('COGSAccountRef ListID');
	}
	...
	{
		return $this->getD('COGSAccountRef FullName');
	}
	...
	{
		return $this->getD('PrefVendorRef ' . QUICKBOOKS_API_APPLICATIONID);
	}
	
	public function getPreferredVendorListID()
	{
		return $this->getD('PrefVendorRef ListID');
	}
	
	public function getPreferredVendorName()
	{
		return $this->getD('PrefVendorRef FullName');
	}
