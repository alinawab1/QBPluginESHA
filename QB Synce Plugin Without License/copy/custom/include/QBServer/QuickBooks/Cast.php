	...
	static public function cast($type_or_action, $field, $value, $use_abbrevs = true, $htmlspecialchars = true)
	{
		...
		*/
		...
		if (isset($types[$type_or_action]))
		{
			...
			$class['index'] = 'QuickBooks_QBXML_Schema_Object_' . $types[$type_or_action];
			$schema = new $class['index']();
		}
		else if (isset($types3[$type_or_action]))		// substr -3
		{
			...
			$class['index'] = 'QuickBooks_QBXML_Schema_Object_' . $types3[$type_or_action];
			$schema = new $class['index']();
		}
		else if (isset($types5[$type_or_action]))		// substr -5
		{
			...
			$class['index'] = 'QuickBooks_QBXML_Schema_Object_' . $types5[$type_or_action];
			$schema = new $class['index']();
		}
		//else
		//{
