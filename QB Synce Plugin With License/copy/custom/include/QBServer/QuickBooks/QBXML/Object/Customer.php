...
class QuickBooks_QBXML_Object_Customer extends QuickBooks_QBXML_Object
{
	...
	{
		return $this->getD('ParentRef ' . QUICKBOOKS_API_APPLICATIONID);
	}
	...
	{
		return $this->getD('TermsRef ' . QUICKBOOKS_API_APPLICATIONID);
	}*/
	...
	{
		return $this->getD('SalesRepRef ' . QUICKBOOKS_API_APPLICATIONID);
	}*/
	...
	{
		return $this->getD('DeliveryMethod');
	}
	...
	protected function _getXYZAddress($pre, $post, $part = null, $defaults = array())
	{
		if (!is_null($part))
		{
			return $this->getD($pre . 'Address' . $post . ' ' . $part);
		}
	...
	{
		return $this->getD('AccountNumber');
	}
	...
	{
		return $this->getD('Salutation');
	}
			
	public function getCustomerTypeApplicationID()
	{
		return $this->getD('CustomerTypeRef ' . QUICKBOOKS_API_APPLICATIONID);
	}
	
	public function getCustomerTypeListID()
	{
		return $this->getD('CustomerTypeRef ListID');
	}
	
	public function getCustomerTypeName()
	{
		return $this->getD('CustomerTypeRef FullName');
	}
	...
	{
		return $this->getD('SalesTaxCodeRef ' . QUICKBOOKS_API_APPLICATIONID);
	}
	...
	{
		return $this->getD('PriceLevelRef ' . QUICKBOOKS_API_APPLICATIONID);
	}
	
	public function getPriceLevelName()
	{
		return $this->getD('PriceLevelRef FullName');
	}
	...
	{
		return $this->getD('PreferredDeliveryMethod');
	}
	...
	{
		return $this->getD('PriceLevelRef ListID');
	}
