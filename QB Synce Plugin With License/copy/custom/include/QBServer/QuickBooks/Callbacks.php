...
class QuickBooks_Callbacks
{
	...
	static protected function _callFunction($function, &$vars, &$err, $which = null)
	{
		...
		if(count($vars) <= 0) {
			...
			$ret = $tmp['func']($vars[0], $vars[1]);
		} else if(count($vars) == 3) {
			$ret = $tmp['func']($vars[0], $vars[1], $vars[2]);
		} else if(count($vars) == 4) {
			$ret = $tmp['func']($vars[0], $vars[1], $vars[2], $vars[3]);
		} else if(count($vars) == 5) {
			$ret = $tmp['func']($vars[0], $vars[1], $vars[2], $vars[3], $vars[4]);
		} else if(count($vars) == 6) {
			$ret = $tmp['func']($vars[0], $vars[1], $vars[2], $vars[3], $vars[4], $vars[5]);
		} else if(count($vars) == 7) {
			$ret = $tmp['func']($vars[0], $vars[1], $vars[2], $vars[3], $vars[4], $vars[5], $vars[6]);
		} else if(count($vars) == 8) {
			$ret = $tmp['func']($vars[0], $vars[1], $vars[2], $vars[3], $vars[4], $vars[5], $vars[6], $vars[7]);
		} else if(count($vars) == 9) {
			$ret = $tmp['func']($vars[0], $vars[1], $vars[2], $vars[3], $vars[4], $vars[5], $vars[6], $vars[7], $vars[8]);
		} else if(count($vars) == 10) {
			$ret = $tmp['func']($vars[0], $vars[1], $vars[2], $vars[3], $vars[4], $vars[5], $vars[6], $vars[7], $vars[8], $vars[9]);
		} else if(count($vars) == 11) {
			$ret = $tmp['func']($vars[0], $vars[1], $vars[2], $vars[3], $vars[4], $vars[5], $vars[6], $vars[7], $vars[8], $vars[9], $vars[10]);
		} else if(count($vars) == 12) {
			$ret = $tmp['func']($vars[0], $vars[1], $vars[2], $vars[3], $vars[4], $vars[5], $vars[6], $vars[7], $vars[8], $vars[9], $vars[10], $vars[11]);
		} else if(count($vars) == 13) {
			$ret = $tmp['func']($vars[0], $vars[1], $vars[2], $vars[3], $vars[4], $vars[5], $vars[6], $vars[7], $vars[8], $vars[9], $vars[10], $vars[11], $vars[12]);
		} else if(count($vars) == 14) {
			$ret = $tmp['func']($vars[0], $vars[1], $vars[2], $vars[3], $vars[4], $vars[5], $vars[6], $vars[7], $vars[8], $vars[9], $vars[10], $vars[11], $vars[12], $vars[13]);
		} else if(count($vars) == 15) {
			$ret = $tmp['func']($vars[0], $vars[1], $vars[2], $vars[3], $vars[4], $vars[5], $vars[6], $vars[7], $vars[8], $vars[9], $vars[10], $vars[11], $vars[12], $vars[13], $vars[14]);
		}
...
//		$ret = call_user_func_array($function, $vars);
	...
	static protected function _callObjectMethod($object_and_method, &$vars, &$err, $which = null)
	{
		...
		if (method_exists( $object, $method))
		{
			...
			$tmp['method'] = $method;
			if(count($vars) <= 0) {
				$ret = $tmp['class']::$tmp['method']();
			} else if(count($vars) == 1) {
				$ret = $tmp['class']::$tmp['method']($vars[0]);
			} else if(count($vars) == 2) {
				$ret = $tmp['class']::$tmp['method']($vars[0], $vars[1]);
			} else if(count($vars) == 3) {
				$ret = $tmp['class']::$tmp['method']($vars[0], $vars[1], $vars[2]);
			} else if(count($vars) == 4) {
				$ret = $tmp['class']::$tmp['method']($vars[0], $vars[1], $vars[2], $vars[3]);
			} else if(count($vars) == 5) {
				$ret = $tmp['class']::$tmp['method']($vars[0], $vars[1], $vars[2], $vars[3], $vars[4]);
			} else if(count($vars) == 6) {
				$ret = $tmp['class']::$tmp['method']($vars[0], $vars[1], $vars[2], $vars[3], $vars[4], $vars[5]);
			} else if(count($vars) == 7) {
				$ret = $tmp['class']::$tmp['method']($vars[0], $vars[1], $vars[2], $vars[3], $vars[4], $vars[5], $vars[6]);
			} else if(count($vars) == 8) {
				$ret = $tmp['class']::$tmp['method']($vars[0], $vars[1], $vars[2], $vars[3], $vars[4], $vars[5], $vars[6], $vars[7]);
			} else if(count($vars) == 9) {
				$ret = $tmp['class']::$tmp['method']($vars[0], $vars[1], $vars[2], $vars[3], $vars[4], $vars[5], $vars[6], $vars[7], $vars[8]);
			} else if(count($vars) == 10) {
				$ret = $tmp['class']::$tmp['method']($vars[0], $vars[1], $vars[2], $vars[3], $vars[4], $vars[5], $vars[6], $vars[7], $vars[8], $vars[9]);
			} else if(count($vars) == 11) {
				$ret = $tmp['class']::$tmp['method']($vars[0], $vars[1], $vars[2], $vars[3], $vars[4], $vars[5], $vars[6], $vars[7], $vars[8], $vars[9], $vars[10]);
			} else if(count($vars) == 12) {
				$ret = $tmp['class']::$tmp['method']($vars[0], $vars[1], $vars[2], $vars[3], $vars[4], $vars[5], $vars[6], $vars[7], $vars[8], $vars[9], $vars[10], $vars[11]);
			} else if(count($vars) == 13) {
				$ret = $tmp['class']::$tmp['method']($vars[0], $vars[1], $vars[2], $vars[3], $vars[4], $vars[5], $vars[6], $vars[7], $vars[8], $vars[9], $vars[10], $vars[11], $vars[12]);
			} else if(count($vars) == 14) {
				$ret = $tmp['class']::$tmp['method']($vars[0], $vars[1], $vars[2], $vars[3], $vars[4], $vars[5], $vars[6], $vars[7], $vars[8], $vars[9], $vars[10], $vars[11], $vars[12], $vars[13]);
			} else if(count($vars) == 15) {
				$ret = $tmp['class']::$tmp['method']($vars[0], $vars[1], $vars[2], $vars[3], $vars[4], $vars[5], $vars[6], $vars[7], $vars[8], $vars[9], $vars[10], $vars[11], $vars[12], $vars[13], $vars[14]);
			}
...
//			$ret = call_user_func_array(array( $class, $method ), $vars);
	...
	{
		$GLOBALS['log']->fatal(print_r($qb_company_file, 1));
	}
