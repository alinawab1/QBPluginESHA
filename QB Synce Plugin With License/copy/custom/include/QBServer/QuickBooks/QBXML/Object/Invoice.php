...
class QuickBooks_QBXML_Object_Invoice extends QuickBooks_QBXML_Object
{
	...
	{
		return $this->extractApplicationID($this->getD('CustomerRef ' . QUICKBOOKS_API_APPLICATIONID));
	}
	...
	{
		return $this->getD('ClassRef FullName');
	}
	
	public function getClassListID()
	{
		return $this->getD('ClassRef ListID');
	}
	
	/*
	public function getClassApplicationID()
	{
		return $this->extractApplicationID($this->getD('ClassRef ' . QUICKBOOKS_API_APPLICATIONID));
	}
	...
	{
		return $this->extractApplicationID($this->getD('ARAccountRef ' . QUICKBOOKS_API_APPLICATIONID));
	}
	...
	{
		return $this->getD('TemplateRef FullName');
	}
	
	public function getTemplateListID()
	{
		return $this->getD('TemplateRef ListID');
	}
	...
	{
		return $this->extractApplicationID($this->getD('TemplateRef ' . QUICKBOOKS_API_APPLICATIONID));
	}
	...
	public function getShipAddress($part = null, $defaults = array())
	{
		if (!is_null($part))
		{
			return $this->getD('ShipAddress ' . $part);
		}
	...
	public function getBillAddress($part = null, $defaults = array())
	{
		if (!is_null($part))
		{
			return $this->getD('BillAddress ' . $part);
		}
	...
	{
		return $this->getD('TermsRef FullName');
	}
	
	public function getTermsListID()
	{
		return $this->getD('TermsRef ListID');
	}
	...
	{
		return $this->extractApplicationID($this->getD('TermsRef ' . QUICKBOOKS_API_APPLICATIONID));
	}
	...
	{
		//return date($format, strtotime($this->getD('DueDate')));
	...
	{
		return $this->getD('SalesRepRef FullName');
	}
	
	public function getSalesRepListID()
	{
		return $this->getD('SalesRepRef ListID');
	}
	
	public function getSalesRepApplicationID()
	{
		return $this->extractApplicationID($this->getD('SalesRepRef ' . QUICKBOOKS_API_APPLICATIONID));
	}
	
	public function getFOB()
	{
		return $this->getD('FOB');
	}
	...
	public function getShipDate($format = 'Y-m-d')
	{
		...
		{
			return date($format, strtotime($this->getD('ShipDate')));
		}
	...
	{
		return $this->getD('ShipMethodRef FullName');
	}
	
	public function getShipMethodListID()
	{
		return $this->getD('ShipMethodRef ListID');
	}
	...
	{
		return $this->extractApplicationID($this->getD('ShipMethodRef ' . QUICKBOOKS_API_APPLICATIONID));
	}
	...
	{
		return $this->extractApplicationID($this->getD('PaymentMethodRef ' . QUICKBOOKS_API_APPLICATIONID));
	}
	...
	{
		return $this->getD('ItemSalesTaxRef ' . QUICKBOOKS_API_APPLICATIONID);
	}
	...
	{
		return $this->getD('ItemSalesTaxRef FullName');
	}
	
	public function getSalesTaxItemListID()
	{
		return $this->getD('ItemSalesTaxRef ListID');
	}
