 ...
 * PLACE ANY CUSTOMIZATIONS IN QBConfig
 */

require_once("include/SugarObjects/templates/company/Company.php");

class QBConfig_sugar extends Company {
    public $new_schema = true;
    public $module_dir = 'QBConfig';
    public $object_name = 'QBConfig';
    public $table_name = 'qbconfig';
     ...
     * @deprecated
     */
    public function QBConfig_sugar(){
        $GLOBALS['log']->deprecated('Calls to QBConfig::QBConfig are deprecated.');
        self::__construct();
    }
