...
class QuickBooks_QBXML_Object_DataExt extends QuickBooks_QBXML_Object
{
	...
	{
		return $this->getD('ListDataExtType');
	}
	...
	{
		return $this->getD('ListObjRef ListID');
	}
	...
	{
		return $this->getD('ListObjRef FullName');
	}
	...
	{
		return $this->getD('ListObjRef ' . QUICKBOOKS_API_APPLICATIONID);
	}
	...
	{
		return $this->getD('TxnDataExtType');
	}
	...
	{
		return $this->getD(QUICKBOOKS_API_APPLICATIONID);
	}
	...
	{
		return $this->getD('OtherDataExtType');
	}
