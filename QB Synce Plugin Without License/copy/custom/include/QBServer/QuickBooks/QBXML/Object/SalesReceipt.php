...
class QuickBooks_QBXML_Object_SalesReceipt extends QuickBooks_QBXML_Object
{
  ...
  public function getTxnID()
  {
	...
	*/
	...
	{
		return $this->getD('PaymentMethodRef ' . QUICKBOOKS_API_APPLICATIONID);
	}
	...
	{
		return $this->getD('DepositToAccountRef ListID');
	}
	
	public function getDepositToAccountName()
	{
		return $this->getD('DepositToAccountRef FullName');
	}
	...
	{
		return $this->extractApplicationID($this->getD('DepositToAccountRef ' . QUICKBOOKS_API_APPLICATIONID));
	}	
  ...
  public function getLinkToTxnID()
  {
	...
	{
		$lines = $this->getD('SalesReceiptLine');
		$lines[] = $obj;
