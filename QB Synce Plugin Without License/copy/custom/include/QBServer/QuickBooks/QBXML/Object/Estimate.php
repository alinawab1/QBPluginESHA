...
class QuickBooks_QBXML_Object_Estimate extends QuickBooks_QBXML_Object
{
	...
	{
		return $this->getD('ClassRef ' . QUICKBOOKS_API_APPLICATIONID);
	}
	...
	{
		return $this->getD('TemplateRef ' . QUICKBOOKS_API_APPLICATIONID);
	}
	...
	{
		return $this->getD('CustomerSalesTaxCodeRef ListID');
	}
	
	public function getCustomerSalesTaxCodeName()
	{
		return $this->getD('CustomerSalesTaxCodeRef FullName');
	}
